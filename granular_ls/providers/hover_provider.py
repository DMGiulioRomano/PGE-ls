...
_BLOCK_KEY_DOCS = {
    ...
    'deviation_probability': (
        ...
        "| scrittura | esito |\n"
        "|---|---|\n"
        "| chiave assente | nessuna deviazione |\n"
        "| `deviation_probability:` (vuota) | **jitter implicito 1%** |\n"
        "| `deviation_probability: {}` | nessuna deviazione |\n"
        "| `deviation_probability: false` | nessuna deviazione |\n"
        "| `<chiave>:` vuota dentro il dict | nessuna deviazione |\n\n"
        "> Scrivere la chiave e lasciarla vuota è la sola delle cinque che\n"
        "> **non** disattiva niente: accende una deviazione all'1% su ogni\n"
        "> parametro con un range. Per non averne, ometti la chiave o scrivi\n"
        "> `false`.\n\n"
